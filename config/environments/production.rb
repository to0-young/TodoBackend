...
Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ "http://todo-abc.herokuapp.com", /http:\/\/.*\.todo-abc\.herokuapp\.com/ ]
  ...
  # config.active_job.queue_name_prefix = "TodoBackend_production"
